...
export default class Trimesh extends Shape {
  ...
  constructor(vertices: number[], indices: number[], options?: ShapeOptions) {
    super(options);
    ...
    this.tree = new Octree(this.aabb);
    this.updateEdges();
    this.updateNormals();
    this.updateAABB();
   ...
   * @return {Vec3} The "out" vector object
   */
  _getUnscaledVertex(i: number, out: Vec3): Vec3 {
    var i3 = i * 3;
