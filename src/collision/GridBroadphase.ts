...
export default class GridBroadphase extends Broadphase {
  ...
  public aabbMax: Vec3;
  public bins: Body[][];
  public binLengths: number[];

  constructor(
    aabbMin: Vec3 = new Vec3(100, 100, 100),
    aabbMax: Vec3 = new Vec3(-100, -100, -100),
    nx: number = 10,
    ny: number = 10,
    nz: number = 10
  ) {
   ...
   * @param {Array} pairs2
   */
  collisionPairs(world: any, pairs1: any, pairs2: any) {
    ...
    function addBoxToBins(x0, y0, z0, x1, y1, z1, bi) {
      var xoff0 = ((x0 - xmin) * xmult) | 0,
        ...
        xoff1 = Math.ceil((x1 - xmin) * xmult),
        yoff1 = Math.ceil((y1 - ymin) * ymult),
        zoff1 = Math.ceil((z1 - zmin) * zmult);
